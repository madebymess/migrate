...
// import "github.com/madebymess/migrate/migrate" for usage within Go.
package main
...
import (
	...
	"github.com/madebymess/migrate/file"
	"github.com/madebymess/migrate/migrate"
	"github.com/madebymess/migrate/migrate/direction"
	pipep "github.com/madebymess/migrate/pipe"
	"os"
	"strconv"
	"time"
)
